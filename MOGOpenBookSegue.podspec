...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       An optional longer description of MOGOpenBookSegue

                       * Markdown format.
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/MOGOpenBookSegue"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "mogmet" => "mogmet@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/MOGOpenBookSegue.git", :tag => s.version.to_s }
